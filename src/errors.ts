...
export const enum ErrorCode {
	...
	InternalModuleManifestReadError = "I9",
	InternalModuleManifestJSONParseError = "I10",

	UncaughtCLI = "U0",

	ZodReadModuleManifestFailParse = "Z0",
...
export const RuntimeError = (errorCode: ErrorCode, filterId: unknown, message: unknown) =>
